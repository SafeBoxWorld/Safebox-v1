                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <div class="sc-card-product sc-card-article blog-article style">
                                <div class="card-media modelViewer flat-img canta" style="aspect-ratio: 4/4;">
                                    <model-viewer id="canta" class="w-100" disable-pan touch-action="none" interaction-prompt="none" src="../assets/models/backpackson.gltf" ar alt="3d model saat" autoplay="" camera-controls="" auto-rotate="" style="height: 100%;" camera-orbit="-30deg 70deg m" shadow-intensity="0" shadow-softness="0" quick-look-browsers="safari chrome"></model-viewer>                                                                                                                            <div class="col-12 modelAttribute" stye="visibility: hidden;">
                                ...
                                <div class="content">
                                    <h3><a href="index.php?page=product&productId=canta">Sırt Çantası</a></h3> 
                                    <div class="meta-info mb-17">
                                        <div class="author">
                                            <div class="info">
                                                <h5><a class="text-color-3">27 farklı özel seçeneği ile kendine uygun tasarımı seç!</a> </h5>                                       
                                            </div>
                                        </div>                                  
                                    </div>  
                                    <div class="meta-price flex-one">                                              
                                        <div class="price flex">
                                            ...
                                            <div class="title-price"> 2.62 SOL</div>
                                        </div>
                                        <div class="button-place-bid">
                                            <a href="index.php?page=product&productId=canta" class="sc-button btn-3"><span>Satın Al</span></a>
                                        </div>
                                    </div>   
                                </div> 
                            </div> 
                        ...
                        <div class="col-md-4 col-12">
                            <div class="sc-card-product sc-card-article blog-article style">
                                ...
                                <div class="content">
                                    <h3><a href="index.php?page=product&productId=saat">Kol Saati</a></h3> 
                                    <div class="meta-info mb-17">
                                        <div class="author">
                                            <div class="info">
                                                <h5><a class="text-color-3">27 farklı özel seçeneği ile kendine uygun tasarımı seç!</a> </h5>                                       
                                    ...
                                    <div class="meta-price flex-one">                                              
                                        ...
                                        <div class="button-place-bid">
                                            <a href="index.php?page=product&productId=saat" class="sc-button btn-3"><span>Satın Al</span></a>
                                        </div>
                                    </div>   
                                </div> 
                            </div> 
                        ...
                        <div class="col-md-4 col-12">
                            <div class="sc-card-product sc-card-article blog-article style">
                                <div class="card-media modelViewer ayakkabi flat-img" style="aspect-ratio: 4/4;">
                                    <model-viewer id="ayakkabi" class="w-100" disable-pan touch-action="none" interaction-prompt="none" src="../assets/models/shoes2.gltf" ar alt="3d model saat" autoplay="" camera-controls="" auto-rotate="" style="height: 100%;" camera-orbit="-30deg 70deg m" shadow-intensity="0" shadow-softness="0" quick-look-browsers="safari chrome"></model-viewer>                                                                                                                            <div class="col-12 modelAttribute">
                                        <div class="attribute">
                                            <h3>Kordon Seçiniz</h3>
                                            <div class="attributeList my-4">
                                                <button class="attributePicker sc-button" value="../assets/images/materials/ayakkabi/kaplama1.jpg">Beyaz</button>
                                                <button class="attributePicker sc-button" value="../assets/images/materials/ayakkabi/kaplama2.jpg">Mavi</button>
                                                <button class="attributePicker sc-button" value="../assets/images/materials/ayakkabi/kaplama3.jpg">Siyah</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="attribute">
                                            <h3>Ekran Seçiniz</h3>
                                            <div class="attributeList my-4">
                                                <button class="attributePicker sc-button" value="../assets/images/materials/ayakkabi/kaplama1.jpg">Stil 1</button>
                                                <button class="attributePicker sc-button" value="../assets/images/materials/ayakkabi/kaplama2.jpg">Stil 2</button>
                                                <button class="attributePicker sc-button" value="../assets/images/materials/ayakkabi/kaplama3.jpg">Stil 3</button>
                                            </div>
                                        </div>
                                        <div class="attribute mt-4">
                                            <h3>Kadran Seçiniz</h3>
                                ...
                                <div class="content">
                                    <h3><a href="index.php?page=product&productId=ayakkabi">Ayakkabı</a></h3> 
                                    <div class="meta-info mb-17">
                                        <div class="author">
                                            <div class="info">
                                                <h5><a class="text-color-3">27 farklı özel seçeneği ile kendine uygun tasarımı seç!</a> </h5>                                       
                                    ...
                                    <div class="meta-price flex-one">                                              
                                        ...
                                        <div class="button-place-bid">
                                            <a href="index.php?page=product&productId=ayakkabi" class="sc-button btn-3"><span>Satın Al</span></a>
                                        </div>
                                    </div>   
                                </div> 
                            </div> 
