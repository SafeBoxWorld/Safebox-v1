<!-- slider -->
<section class="flat-title-page style2 slider style-home2 style-home3">                    
    ...
    <img class="absolute mark-slider-02 animate-zoom" src="../assets/images/mark/mark-header-07.png" alt="">  
    <div class="swiper-container show-slider show-slider2 mainslider home">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="slider-item">	
                    <div class="themes-container2">
                        <div class="flat-wrap">
                            <div class="wrap-heading flat-slider flex"> 
                                <!-- <img class="absolute mark-page8" src="../assets/images/mark/mark2-slider-home3.png" alt="">                          -->
                                <div class="content">                                       	
                                    <h1 class="heading">Discover Collect <br> and Safe <span class="tf-text style s1">NFT.</span>  </h1>
                                ...
                                <!-- <div class="img-slider">
                                    <div class="box-img">  
                                        <div class="image ">  
                                            <img class="animate-up" src="../assets/images/mark/mark1-slider-home3.png" alt="">                                                                       
                                        </div>                                                                                                        
                                    </div>                                      
                                </div> -->
                            </div>
    ...
    <div class="container">
        <div class="row">  
            <div class="col-lg-12 col-md-12">
                <ul class="flex">
                    <li>
                        <img class="img-icon" src="../assets/images/icon/friendly-01.svg" alt="">
                        <div class="title-friendly fs-24">Decentralized Platform.</div>
                    </li>
                    <li class="style">
                        <img class="img-icon" src="../assets/images/icon/friendly-02.svg" alt="">
                        <div class="title-friendly fs-24">Decentralized Platform.</div>
                    </li>
                    <li>
                        <img class="img-icon" src="../assets/images/icon/friendly-03.svg" alt="">
                        <div class="title-friendly fs-24">Crowd Meet Wisdom</div>
                    </li>
                    <li>
                        <img class="img-icon" src="../assets/images/icon/friendly-04.svg" alt="">
...
<div class="tf-section flat-auctions live-auctions home2">
    <div class="container">
        ...
        <!-- flat cetagories -->
        <div class="flat-cetagories2 home2 home3">
                ...
                <div class="row">  
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-cetagories">
                            <div class="img-cetagories">
                                <img  src="../assets/images/box-item/cetagories-10.jpg" alt="">
                            </div>
                            <div class="content flex">
                                <div class="icon-cetagories">
                                ...
                                <div class="title-cetagories">
                                    <h3 class="fw-4"><a href="#">Creative Arts</a></h3>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-cetagories">
                            <div class="img-cetagories">
                                <img  src="../assets/images/box-item/cetagories-11.jpg" alt="">
                            </div>
                            <div class="content flex">
                                <div class="icon-cetagories">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="title-cetagories">
                                    <h3 class="fw-4"><a href="#">Discovery</a></h3>
                                    <p class="font-2">50+ Items</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-cetagories">
                            <div class="img-cetagories">
                                <img  src="../assets/images/box-item/cetagories-12.jpg" alt="">
                            </div>
                            <div class="content flex">
                                <div class="icon-cetagories">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="title-cetagories">
                                    <h3 class="fw-4"><a href="#">Virtual World</a></h3>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-cetagories">
                            <div class="img-cetagories">
                                <img  src="../assets/images/box-item/cetagories-13.jpg" alt="">
                            </div>
                            <div class="content flex">
                                <div class="icon-cetagories">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="title-cetagories">
                                    <h3 class="fw-4"><a href="#">3D Arts</a></h3>
                                    <p class="font-2">50+ Items</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-cetagories">
                            <div class="img-cetagories">
                                <img  src="../assets/images/box-item/cetagories-14.jpg" alt="">
                            </div>
                            <div class="content flex">
                                <div class="icon-cetagories">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="title-cetagories">
                                    <h3 class="fw-4"><a href="#">Books Arts</a></h3>
                                    <p class="font-2">50+ Items</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-cetagories">
                            <div class="img-cetagories">
                                <img  src="../assets/images/box-item/cetagories-15.jpg" alt="">
                            </div>
                            <div class="content flex">
                                <div class="icon-cetagories">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="title-cetagories">
                                    <h3 class="fw-4"><a href="#">music Arts</a></h3>
                                    <p class="font-2">50+ Items</p>
                                </div>
                            </div>
                        </div>
         ...
         <!-- flat explore -->
         <div class="tf-section flat-explore flat-auctions mt-3 home2">
            <div class="container">
                <div class="row">                  
                    <div class="col-lg-6 col-sm-12">
                        <div class="heading-section2 style">
                            <h2 class="fw-5">Explore Assets NFTS</h2>
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.</p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="swiper-container carousel-5 auctions show-slider3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="sc-card-product sc-card-article blog-article">
                                        <div class="card-media flat-img">
                                            <a class="images" href="live-auctions-details.html"><img class="img-item" src="../assets/images/box-item/auctions-5.jpg" alt="Image"></a>                                                                                                                                                                                                     
                                        </div>  
                                        <div class="content">
                                            <h6 class="tags">6 in stock</h6>  
                                            <h3><a href="live-auctions-details.html"> Axtronic Electronics VS-10 </a></h3> 
                                ...
                                <div class="swiper-slide">
                                    <div class="sc-card-product sc-card-article blog-article">
                                        <div class="card-media flat-img">
                                            <a class="images" href="live-auctions-details.html"><img class="img-item" src="../assets/images/box-item/auctions-6.jpg" alt="Image"></a>                                                                                                                                                                                                     
                                        </div>  
                                        <div class="content">
                                            <h6 class="tags">6 in stock</h6>  
                                            <h3><a href="live-auctions-details.html"> Axtronic Electronics VS-10 </a></h3> 
                                ...
                                <div class="swiper-slide">
                                    <div class="sc-card-product sc-card-article blog-article">
                                        <div class="card-media flat-img">
                                            <a class="images" href="live-auctions-details.html"><img class="img-item" src="../assets/images/box-item/auctions-3.jpg" alt="Image"></a>                                                                                                                                                                                                     
                                        </div>  
                                        <div class="content">
                                            <h6 class="tags">5 in stock</h6>  
                                            <h3><a href="live-auctions-details.html"> Axtronic Electronics VS-10 </a></h3> 
                                ...
                                <div class="swiper-slide">
                                    <div class="sc-card-product sc-card-article blog-article">
                                        <div class="card-media flat-img">
                                            <a class="images" href="live-auctions-details.html"><img class="img-item" src="../assets/images/box-item/auctions-7.jpg" alt="Image"></a>                                                                                                                                                                                                     
                                        </div>  
                                        <div class="content">
                                            <h6 class="tags">4 in stock</h6>  
                                            <h3><a href="live-auctions-details.html"> Axtronic Electronics VS-10 </a></h3> 
         ...
         <!-- flat featured -->
         <div class="tf-section flat-featured home2 home3">
            <div class="container">
                <div class="row">                  
                    <div class="col-lg-4 col-md-4">
                        <div class="wrap-featured center">
                            <div class="box-img">
                                <img src="../assets/images/box-item/featured-1.png" alt="">
                            </div>
                            <div class="content">
                                <h3 class="fw-4"><a href="connect-wallet.html">Add Your NFTS</a></h3>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="wrap-featured center">
                            <div class="box-img">
                                <img src="../assets/images/box-item/featured-2.png" alt="">
                            </div>
                            <div class="content">
                                <h3 class="fw-4"><a href="connect-wallet.html">Setup Wallet</a></h3>
                                <p>Mauris nec dictum lacus, quis pretium nunc. Aenean malesuada sem et accumsan sagittis.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="wrap-featured center">
                            <div class="box-img">
                                <img src="../assets/images/box-item/featured-3.png" alt="">
                            </div>
                            <div class="content">
                                <h3 class="fw-4"><a href="connect-wallet.html">Create Collection</a></h3>
                                <p>Mauris nec dictum lacus, quis pretium nunc. Aenean malesuada sem et accumsan sagittis.</p>
                            </div>
                        </div>
                    </div>
          ...
          <!-- flat top seller -->
          <div class="flat-top-seller home3">
            <div class="themes-container2 style-container">
            <div class="container">
                <div class="row">                  
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-seller center">
                            <div class="img-box flat-img">
                                <div class="img-author"><img src="../assets/images/box-item/top-saller-1.jpg" alt=""></div>
                                <img class="check" src="../assets/images/icon/icon-check.svg" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="author-profile.html">Liam Olivia</a></h3>
                                <div class="price flex">
                                    <img class="" src="../assets/images/icon/icon-diamond.svg" alt="">
                                    <div class="title-price fs-16 text-color-4"> 2.39 ETH</div>
                                </div>
                                <div class="button-follow">
                                    <a href="#" class="sc-button btn-7"><span>Follow</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-seller center">
                            <div class="img-box flat-img">
                                <div class="img-author"><img src="../assets/images/box-item/top-saller-2.jpg" alt=""></div>
                                <img class="check" src="../assets/images/icon/icon-check.svg" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="author-profile.html">Liam Olivia</a></h3>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-seller center">
                            <div class="img-box flat-img">
                                <div class="img-author"><img src="../assets/images/box-item/top-saller-3.jpg" alt=""></div>
                                <img class="check" src="../assets/images/icon/icon-check.svg" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="author-profile.html">Liam Olivia</a></h3>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-seller center">
                            <div class="img-box flat-img">
                                <div class="img-author"><img src="../assets/images/box-item/top-saller-4.jpg" alt=""></div>
                                <img class="check" src="../assets/images/icon/icon-check.svg" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="author-profile.html">Liam Olivia</a></h3>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-seller center">
                            <div class="img-box flat-img">
                                <div class="img-author"><img src="../assets/images/box-item/top-saller-5.jpg" alt=""></div>
                                <img class="check" src="../assets/images/icon/icon-check.svg" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="author-profile.html">Liam Olivia</a></h3>
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="wrap-seller center">
                            <div class="img-box flat-img">
                                <div class="img-author"><img src="../assets/images/box-item/top-saller-6.jpg" alt=""></div>
                                <img class="check" src="../assets/images/icon/icon-check.svg" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="author-profile.html">Liam Olivia</a></h3>
                    ...
                    <div class="col-lg-12">
                        <h3 class="title center font fw-6 mt-58 text-t text-color-4">Empowering 230,000+ Businesses with Innovation <span class="text-color-3">Top Creators</span> Digital NFT Marketplace. </h3>
                    </div>
                </div>
            </div>
            </div>
             ...
             <!-- flat collection -->
             <div class="flat-collection home3">
                <div class="container">
                    <div class="row">                  
                        <div class="col-lg-6 col-sm-12">
                                                ...
                                                <div class="flat-tabs card-media media">                                 
                                                    <div class="content-tab content-img">
                                                        <div class="content-inner tab-content">
                                                            <img src="../assets/images/box-item/conlection-1.jpg" alt="">
                                                        </div>
                                                        <div class="content-inner tab-content">
                                                            <img src="../assets/images/box-item/conlection-13.jpg" alt="">
                                                        </div>
                                                        <div class="content-inner tab-content">
                                                            <img src="../assets/images/box-item/conlection-17.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <ul class="menu-tab menu-img">
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-2.jpg" alt="">
                                                        </li>
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-3.jpg" alt="">
                                                        </li>
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-4.jpg" alt="">
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="post">
                                                    ...
                                                    <div class="meta-info">
                                                        ...
                                                        <div>
                                                            <div class="item-nft flex-one">                                                       
                                                                <img class="img-nft" src="../assets/images/icon/icon-nft.svg" alt="">
                                                                <h4>805 Items</h4>
                                                            </div>
                                                        </div>                                  
                                                    </div> 
                                        ...
                                        <div class="fl-blog fl-item2">
                                            <article class="sc-card-article blog-article style-article">                                    
                                                <div class="flat-tabs card-media media">                                 
                                                    <div class="content-tab content-img">
                                                        <div class="content-inner tab-content">
                                                            <img src="../assets/images/box-item/conlection-5.jpg" alt="">
                                                        </div>
                                                        <div class="content-inner tab-content">
                                                            <img src="../assets/images/box-item/conlection-21.jpg" alt="">
                                                        </div>
                                                        <div class="content-inner tab-content">
                                                            <img src="../assets/images/box-item/conlection-9.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <ul class="menu-tab menu-img">
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-6.jpg" alt="">
                                                        </li>
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-7.jpg" alt="">
                                                        </li>
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-8.jpg" alt="">
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="post">
                                        ...
                                        <div class="fl-blog fl-item2">
                                            <article class="sc-card-article blog-article style-article">                                                                                                     
                                                <div class="flat-tabs card-media media">                                 
                                                    ...
                                                    <ul class="menu-tab menu-img">
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-10.jpg" alt="">
                                                        </li>
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-11.jpg" alt="">
                                                        </li>
                                                        <li class="item-title">
                                                            <img src="../assets/images/box-item/conlection-12.jpg" alt="">
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="post">
                                        ...
                                        <div class="fl-blog fl-item2">
                                            <article class="sc-card-article blog-article style-article">                                         
                                                <div class="flat-tabs card-media media">                                 
                                                    <div class="content-tab content-img">
                                                        <div class="content-inner tab-content">
                                                            <div class=""><img src="../assets/images/box-item/conlection-1.jpg" alt=""></div>
                                                        </div>
                                                        <div class="content-inner tab-content">
                                                            <div class="img-item-"><img src="../assets/images/box-item/conlection-5.jpg" alt=""></div>
                                                        </div>
                                                        <div class="content-inner tab-content">
                                                            <div class="img-item-"><img src="../assets/images/box-item/conlection-13.jpg" alt=""></div>
                                                        </div>
                                                    </div>
                                                    <ul class="menu-tab menu-img">
                                                        <li class="item-title">
            ...
            <!-- flat help -->
            <div class="flat-help home2 home3">
                <div class="themes-container3 style-container">
                    <!-- themes-container3 -->
                    <div class="row ">             
                        ...
                        <div class="col-lg-7 col-md-7">
                            <div class="widget-subcribe home2 home3">
                    ...
                    <div class="row">                  
                            ...
                            <div class="fl-blog fl-item2">
                                <article class="sc-card-article blog-article">
                                    <div class="card-media">
                                        <a href="blog-details.html"><img class="img-item" src="../assets/images/blog/blog-1.jpg" alt=""></a>
                                    </div>    
                                    <div class="post">
                                        <div class="text-article">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="fl-blog fl-item2">
                                <article class="sc-card-article blog-article">
                                    <div class="card-media">
                                        <a href="blog-details.html"><img class="img-item" src="../assets/images/blog/blog-2.jpg" alt=""></a>
                                    </div>    
                                    <div class="post">
                                        <div class="text-article">
                                            <h3><a href="blog-details.html">Axtronic Electronics VS-10</a></h3>
                                        ...
                                        <div class="meta-info style">
                                            <div class="author">
                                                <div class="avatar">
                                                    <img src="../assets/images/avatar/avt-02.png" alt="">
                                                </div>
                                                <div class="info">
                                                    <h5> By<a class="text-color-3" href="author-profile.html"> Themesflat</a> </h5>
                                                    <div class="date"> Date <span class="text-color-6"> 04/10/2022</span></div>                                           
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="fl-blog fl-item2">
                                <article class="sc-card-article blog-article">
                                    <div class="card-media">
                                        <a href="blog-details.html"><img class="img-item" src="../assets/images/blog/blog-3.jpg" alt=""></a>
                                    </div>    
                                    <div class="post">
                                        <div class="text-article">
                                            <h3><a href="blog-details.html">Axtronic Electronics VS-10</a></h3>
                                        ...
                                        <div class="meta-info style">
                                            <div class="author">
                                                <div class="avatar">
                                                    <img src="../assets/images/avatar/avt-03.png" alt="">
                                                </div>
                                                <div class="info">
                                                    <h5> By<a class="text-color-3" href="author-profile.html"> Themesflat</a> </h5>
                                                    <div class="date"> Date <span class="text-color-6"> 04/10/2022</span></div>                                           
